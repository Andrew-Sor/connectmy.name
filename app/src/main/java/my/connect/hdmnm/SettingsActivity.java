...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void loadDataToUI() {
        ...
        if(prefs.getString("success_date_time", null) != null) {
            tvDebugLauncherMode.setText("Послед. проб. период: " + prefs.getString("success_date_time", "пусто") + "; сейчас: " + LocalDateTime.now() + "; прошли сутки: " + !(Duration.between(LocalDateTime.parse(prefs.getString("success_date_time", null)), LocalDateTime.now()).toMinutes() <= 23*60));
        };
    };
